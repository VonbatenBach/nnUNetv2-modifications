...
class SimpleITKIO(BaseReaderWriter):
    ...
    def write_seg(self, seg: np.ndarray, output_fname: str, properties: dict, probabilities: bool = False) -> None:
        ...
        ### HERE IS CUSTOM MODIFICATION, WHICH ALLOWS TO SAVE PROBABILITIES (as float32) OF ONE CHOSEN CHANNEL ###
        if probabilities:
